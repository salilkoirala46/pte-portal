...
<template>
    <div class="space-y-6 max-w-3xl">
        <div class="flex items-center gap-3">
            <Link :href="route('student.speaking.index')" class="text-gray-400 hover:text-gray-600">
        ...
        <div v-if="questions.length" class="space-y-3">
            <Link
                ...
                :key="q.id"
                :href="route('student.speaking.question', q.id)"
            ...
            >
                ...
                <span class="text-purple-600 text-sm font-medium group-hover:underline flex-shrink-0">Practice →</span>
            </Link>
        </div>
